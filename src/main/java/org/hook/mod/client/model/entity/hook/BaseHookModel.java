package org.hook.mod.client.model.entity.hook;
...
public class BaseHookModel extends EntityModel<BaseHookEntity> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Hook.MODID, "base_hook"), "main");
