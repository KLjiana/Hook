...
import org.hook.mod.datagen.limit.CustomItemModel;
import org.hook.mod.datagen.limit.Image32x;
import org.hook.mod.datagen.limit.Image64x;
    ...
    protected void registerModels() {
        ModItems.ITEMS.getEntries().forEach(item -> {
            ...
            try {
                ...
                Hook.LOGGER.error(e.getMessage());
