package org.confluencehook.mod.client.model.entity.hook;
...
public class BaseHookModel extends EntityModel<BaseHookEntity> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(ConfluenceHook.MODID, "base_hook"), "main");
