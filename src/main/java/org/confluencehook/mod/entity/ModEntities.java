package org.confluencehook.mod.entity;
...
import org.confluencehook.mod.entity.hook.*;

@SuppressWarnings("unused")
public final class ModEntities {
    public static final DeferredRegister<EntityType<?>> ENTITIES = DeferredRegister.create(ForgeRegistries.ENTITY_TYPES, ConfluenceHook.MODID);
